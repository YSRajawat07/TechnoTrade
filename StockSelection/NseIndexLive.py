...
from NseATMCalculations import *
...
syspath =config.get('filedetails', 'syspath')
...
wb.sheets['FutureData'].range('2:500').clear_contents()
wb.sheets['MPDataput'].range('2:500').clear_contents()
wb.sheets['MPDatacall'].range('2:500').clear_contents()
wb.sheets['CallData'].range('2:500').clear_contents()
wb.sheets['PutData'].range('2:500').clear_contents()
wb.sheets['zscore'].range('2:500').clear_contents()
wb.sheets['NearATMDatacall'].range('2:500').clear_contents()
#wb.sheets['NearATMDataput'].range('2:50000').clear_contents()
wb.sheets['CallDataATM'].range('2:500').clear_contents()
wb.sheets['PutDataATM'].range('2:500').clear_contents()
