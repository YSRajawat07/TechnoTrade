...
def nearatmstrikes(mpcall_df, df_opdata,dfzscorerec):
    ...
    'changeinOpenInterest_x':'changeinOpenInterest_Call','totalTradedVolume_x':'totalTradedVolume_Call',
     'impliedVolatility_x':'impliedVolatility_Call','lastPrice_x':'lastPrice_Call','openInterest_y': 'openInterest_Put',
    ...
    df_opdata = df_opdata.filter(
       ['Time','underlying', 'openInterest_Call', 'totalTradedVolume_Call', 'changeinOpenInterest_Call', 'impliedVolatility_Call',
...
######Need to take minimuum value hence addiding put to call writer and vice versa#########
    ...
    callwriterspositive = maxmatrixcall[
        ['lastPrice_Callweight', 'impliedVolatility_Callweight', 'changeinOpenInterest_Callweight','OpenInterest_Callweight','totalTradedVolume_Callweight']]
    callwriterspositive['CHOI_Vol_Callweight'] = minmatrixcall[['CHOI_Vol_Callweight']]

    callwriterspositive =callwriterspositive[['CHOI_Vol_Callweight','lastPrice_Callweight', 'impliedVolatility_Callweight', 'changeinOpenInterest_Callweight','OpenInterest_Callweight','totalTradedVolume_Callweight']]

    callwritersnegative =minmatrixcall[['lastPrice_Callweight','impliedVolatility_Callweight','changeinOpenInterest_Callweight','OpenInterest_Callweight','totalTradedVolume_Callweight']]
  ...
  #  callwritersnegative =callwritersnegative[['CHOI_Vol_Callweight','lastPrice_Callweight', 'impliedVolatility_Callweight', 'changeinOpenInterest_Callweight','OpenInterest_Callweight','totalTradedVolume_Callweight']]
    ...
    putwriterspositive = maxmatrixput[
                      ['lastPrice_Putweight', 'impliedVolatility_Putweight', 'changeinOpenInterest_Putweight','OpenInterest_Putweight','totalTradedVolume_Putweight']]
  ...
  #  putwriterspositive = putwriterspositive[['CHOI_Vol_Putweight','lastPrice_Putweight', 'impliedVolatility_Putweight', 'changeinOpenInterest_Putweight','OpenInterest_Putweight','totalTradedVolume_Putweight']]
    ...
    putwritersnegative = putwritersnegative[['CHOI_Vol_Putweight','lastPrice_Putweight', 'impliedVolatility_Putweight', 'changeinOpenInterest_Putweight','OpenInterest_Putweight','totalTradedVolume_Putweight']]
...
###### Finding relative closeness formula in TOPSIS method#######################
    ...
    putdistanceputpos['closeness'] =round(( putdistanceputpos['sqrt'] / (putdistanceputneg['sqrt'] +putdistanceputpos['sqrt'])),2)
    calldistancecallpos['closeness'] =round(( calldistancecallpos['sqrt'] / (calldistancecallpos['sqrt'] +calldistancecallneg['sqrt'])),2)
    ...
    zscore_dict = {datetime.now().strftime("%d-%m %H:%M"): {'underlying': nifty['lastPrice'].item(),
                                                           ...
                                                           # 'Strikeprice': dfopscoreatm['strikePrice'][0],
                                                            ...
                                                            'PutPremiumDecreasing': dfopscoreatm['PutPremiumDecreasing'][0],
                                                            'CallPremiumDecreasing': dfopscoreatm['CallPremiumDecreasing'][0],
                                                            'PutPremiumIncreasing': dfopscoreatm['PutPremiumIncreasing'][0],
                                                            'CallPremiumIncreasing': dfopscoreatm['CallPremiumIncreasing'][0],
    ...
    mp_dict_opdata = {datetime.now().strftime("%d-%m %H:%M"): {'underlying': df_opdata['underlying'][0],
                                                             ...
                                                             'Chng_in_OI_Call': df_opdata['changeinOpenInterest_Call'][
                                                                 0],
...
def positions(dfreference,dfzscorerec,calldistancemean,putdistancemean):
    ...
    dfopscore.rename(columns={'CHOI_Vol_Callweight': 'CHOI_Vol_Call', 'lastPrice_Callweight': 'lastPrice_Call',
                     ...
                     'OpenInterest_Callweight': 'openInterest_Call','totalTradedVolume_Callweight':'totalTradedVolume_Call',
                     ...
                     'OpenInterest_Putweight': 'openInterest_Put','totalTradedVolume_Putweight':'totalTradedVolume_Put'}, inplace=True)

    dfopscoreatm=dfopscore.filter([ 'CHOI_Vol_Call', 'lastPrice_Call','impliedVolatility_Call','totalTradedVolume_Call',
...
#def main():
    ...
    wb.sheets['zscoredash'].range("A1").options(header=True).value = dfzscorerec[['CallBuyersActive','CallPremiumIncreasing','CallPremiumDecreasing','CallWritersActive','PutBuyersActive','PutPremiumIncreasing','PutPremiumDecreasing','PutWritersActive','call_score','put_score','score','underlying']]
